...
public class BadgeController {
  ...
  /**
   * Initialize the badges according to the user data The user data contains different badges
   * obtained by the user. The opacity of each badge icon will be determined.
   *
   * @throws IOException
   */
  public void initialize() throws IOException {
    // The opacity of the badge icon is 0.2 initially, and if the user got the badge it should be
    // 1.0
  ...
  /**
   * When user presses the return button, reset the scene to the main menu
   *
   * @param event
   */
  @FXML
