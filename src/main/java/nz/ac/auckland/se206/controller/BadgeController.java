  ...
  public void initialize() throws IOException {
	  Image returnImg = new Image("/images/returnIcon.png");
	    ...
	    for (int badgeIdx : badgesIdx) {
	    	if (badgeIdx == 0) {bronzeOne.setOpacity(1.0);}
	    	else if (badgeIdx == 1) {bronzeTwo.setOpacity(1.0);}
	    	else if (badgeIdx == 2) {bronzeThree.setOpacity(1.0);}
	    	else if (badgeIdx == 3) {bronzeFour.setOpacity(1.0);}
	    	else if (badgeIdx == 4) {bronzeFive.setOpacity(1.0);}
	    	else if (badgeIdx == 5) {silverOne.setOpacity(1.0);}
	    	else if (badgeIdx == 6) {silverTwo.setOpacity(1.0);}
	    	else if (badgeIdx == 7) {silverThree.setOpacity(1.0);}
	    	else if (badgeIdx == 8) {silverFour.setOpacity(1.0);}
	    	else if (badgeIdx == 9) {silverFive.setOpacity(1.0);}
	    	else if (badgeIdx == 10) {goldOne.setOpacity(1.0);}
	    	else if (badgeIdx == 11) {goldTwo.setOpacity(1.0);}
	    	else if (badgeIdx == 12) {goldThree.setOpacity(1.0);}
	    	else if (badgeIdx == 13) {goldFour.setOpacity(1.0);}
	    	else if (badgeIdx == 14) {goldFive.setOpacity(1.0);}
	    	else if (badgeIdx == 15) {diamondOne.setOpacity(1.0);}
	    	else if (badgeIdx == 16) {diamondTwo.setOpacity(1.0);}
	    	else if (badgeIdx == 17) {diamondThree.setOpacity(1.0);}
	    	else if (badgeIdx == 18) {diamondFour.setOpacity(1.0);}
	    	else if (badgeIdx == 19) {diamondFive.setOpacity(1.0);}
	    }
  }
